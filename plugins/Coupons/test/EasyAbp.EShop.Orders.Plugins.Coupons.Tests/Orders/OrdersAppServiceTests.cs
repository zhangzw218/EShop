...
namespace EasyAbp.EShop.Plugins.Coupons.Coupons
{
    public class OrdersAppServiceTests : EShopOrdersPluginsCouponsTestBase
    {
        ...
        public async Task Should_Order_Using_Coupons_DiscountAmount(decimal couponConditionAmount, decimal couponDiscountAmount, decimal productSkuPrice,decimal discountAmount, CouponType couponType)
        {
